...
- **Carga de sesión:** estima el tiempo real de cada sesión de cocina (sumando preparaciones, considerando lo paralelizable) y compáralo con su tope de `organizacion_hogar`; si no cabe, es ❌. Cada sesión debe caber cocinando **fresco** para los días que abastece: un plan que para caber depende de "siembra" (cocinar preparaciones por adelantado en otra sesión) o que aprieta el cronograma en el papel es ❌ — lo correcto es simplificar el menú de esos días.
