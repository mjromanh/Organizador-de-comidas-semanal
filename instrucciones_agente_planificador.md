...
- **Continuidad entre semanas (potes y stock):** cada plan **define el contenido exacto** de todo pote que se empaca para la semana siguiente (p. ej. el pote del martes próximo, empacado el jueves) y programa su descongelado (noche del lunes). Al planificar, **lee del plan anterior** qué contiene el pote del martes actual y cítalo tal cual; si el plan anterior no lo especificó, asume lo congelable de esa sesión y **márcalo como supuesto**. Nunca dejes un pote "a definir".
