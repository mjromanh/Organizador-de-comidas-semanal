...
1. ☐ **Menú** — desayuno + almuerzo + cena, **todos los comensales y días**; comidas del bebé estructuradas (proteína + 1 carbohidrato + ≥3 verduras de colores; la fruta no se planifica en el menú — ver `perfiles_dieta`); **resumen de frecuencias por comensal con su verificación**.
