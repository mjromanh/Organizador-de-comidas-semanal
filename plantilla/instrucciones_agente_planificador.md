...
- **Continuidad entre semanas (potes, siembra y stock):** cada plan **define el contenido exacto** de todo lo que se empaca o congela para la semana siguiente (potes de un día futuro, preparaciones cocinadas por adelantado) y programa su descongelado. Al planificar, **lee del plan anterior** qué se heredó para el día actual, cítalo tal cual y construye el menú sobre ello; si el plan anterior no lo especificó, asúmelo y **márcalo como supuesto**. Nunca dejes un pote o preparación heredada "a definir".
...
**Verificaciones clave:** cada sesión trae un **cronograma en minutos** (ej. 0–10, 10–25…, contando lo que hierve solo en paralelo) y cabe en su **tope de tiempo real** según `organizacion_hogar`; la **sesión más corta** no debe sobrecargarse (si no cabe, mueve lo congelable a una sesión previa —siembra— o simplifica el menú de esos días; no aprietes el cronograma en el papel); recetas claras y ejecutivas, paso a paso, **con la cantidad de cada ingrediente (idealmente en gramos)**.
