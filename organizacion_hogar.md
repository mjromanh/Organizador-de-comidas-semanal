...
> Datos operativos del hogar que usa el planificador. Intercambiable: para otra casa, se reemplaza este archivo y las instrucciones genéricas no cambian.

## Ciclo de planificación y compra

- Semana de planificación: de **martes a lunes** (el martes es el primer día de cocina = inicio de semana; llegan las compras y se cocina; el lunes es el último día).
- Compra: pedido único, 1×/semana. Se **pide el lunes**, **llega el martes**; la cocinera la guarda.

## Días y horarios de cocina

- Solo se cocina **martes** y **jueves**:
  - **Martes (~1 h):** sesión corta.
...
- Olla, sartén, horno, procesadora/minipimer.
- Airfryer chica: solo acompañamientos o BLW.
- No usar equipos fuera de esta lista.
- La cocinera es de nivel intermedio y sigue instrucciones; el límite es el tiempo → recetas claras, paso a paso, en paralelo.

## Conservación

- Máximo **2–3 días en refrigerador**; el resto, congelado.
- Cada preparación tiene un destino: pote de oficina / refri / freezer.

## Presupuesto

- Referencia: **$60.000–$70.000 CLP/semana** en comida.
- Tope: **$100.000 CLP/semana** (no superar).
- Estilo casero/chileno, a veces asiático; temporada y buen precio.
